    ...
    return (
        <div className="">
           <div className="w-full flex mb-8 mt-2">
                <DualSearchInput categoryId={category_id} product_1={product_1} setProduct_1_Data={setProduct_1_Data} product_2={product_2} setProduct_2_Data={setProduct_2_Data} />
            </div>
